...
class ClosedAssessment extends StatefulWidget {
  @override
  _ClosedAssessmentState createState() => _ClosedAssessmentState();
}

class _ClosedAssessmentState extends State<ClosedAssessment> {
  String groupValue;
  String monthValue;
  String query;

  bool loading = false;
  List<bool> loader = [false];
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ClosedProvider>(context);
    ...
    writeOnPdf(
        ...
        String siteRisProfile1,
        String siteRisProfile2,
        String siteRisProfile11,
        String siteRisProfile22,
        String siteRisProfile111,
        String siteRisProfile222,
        String summaryOfRiskProfile1,
        String summaryOfRiskProfile2,
        String summaryOfRiskProfile11,
        String summaryOfRiskProfile22,
        String summaryOfRiskProfile111,
        String summaryOfRiskProfile222,
        String fireRiskProfile1,
        String fireRiskProfile2,
        String fireRiskProfile11,
        String fireRiskProfile22,
        String fireRiskProfile111,
        String fireRiskProfile222,
        String officeRiskProfile1,
        String officeRiskProfile2,
        String officeRiskProfile11,
        String officeRiskProfile22,
        String officeRiskProfile111,
        String officeRiskProfile222,
        String sitepoint1,
        String sitepoint2,
        String sitepoint3,
        String sitepoint4,
        String sitepoint5,
        String wayForwardone,
        String wayForwardtwo) async {
                                      ...
                                      child: Row(children: [
                                        ...
                                        RaisedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            writeOnPdf(
                                                provider.closedAssessmentList[index]
                                                    ['name'],
                                                provider.closedAssessmentList[index]
                                                    ['location'],
                                                provider.closedAssessmentList[index]
                                                ...
                                                provider.closedAssessmentList[index]
                                                    ['coAssessorName'],
                                                provider.listOfValues[
                                                    'processLevel'],
                                                provider.listOfValues[
                                                    'resultLevel'],
                                                provider.listOfValues[
                                                    'lastAssessmentStage'],
                                                provider.listOfValues['lpg'],
                                                provider.listOfValues['diesel'],
                                                provider
                                                    .listOfValues['gasoline'],
                                                provider
                                                    .listOfValues['thinner'],
                                                provider.listOfValues['cng'],
                                                provider.listOfValues['toxic'],
                                                provider
                                                    .listOfValues['paintShop'],
                                                provider.listOfValues['heat'],
                                                provider
                                                    .listOfValues['foundry'],
                                                provider.listOfValues['press'],
                                                provider.listOfValues['ibr'],
                                                provider
                                                    .listOfValues['testBed'],
                                                provider.listOfAssessment,
                                                provider.listOfSummaryRiskProfile[0]
                                                    ['point1'],
                                                provider.listOfSummaryRiskProfile[0]
                                                    ['point2'],
                                                provider.listOfSummaryRiskProfile[1]
                                                    ['point1'],
                                                provider.listOfSummaryRiskProfile[1]
                                                    ['point2'],
                                                provider.listOfSummaryRiskProfile[2]
                                                    ['point1'],
                                                provider.listOfSummaryRiskProfile[2]
                                                    ['point2'],
                                                provider.listOfSiteRiskProfile[0]
                                                    ['point1'],
                                                provider.listOfSiteRiskProfile[0]
                                                    ['point2'],
                                                provider.listOfSiteRiskProfile[1]
                                                    ['point1'],
                                                provider.listOfSiteRiskProfile[1]
                                                    ['point2'],
                                                provider.listOfSiteRiskProfile[2]
                                                    ['point1'],
                                                provider.listOfSiteRiskProfile[2]
                                                    ['point2'],
                                                provider.listOfFireRiskProfile[0]
                                                    ['point1'],
                                                provider.listOfFireRiskProfile[0]
                                                    ['point2'],
                                                provider.listOfFireRiskProfile[1]
                                                    ['point1'],
                                                provider.listOfFireRiskProfile[1]
                                                    ['point2'],
                                                provider.listOfFireRiskProfile[2]
                                                    ['point1'],
                                                provider.listOfFireRiskProfile[2]
                                                    ['point2'],
                                                provider.listOfOfficeRiskProfile[0]
                                                    ['point1'],
                                                provider.listOfOfficeRiskProfile[0]
                                                    ['point2'],
                                                provider.listOfOfficeRiskProfile[1]['point1'],
                                                provider.listOfOfficeRiskProfile[1]['point2'],
                                                provider.listOfOfficeRiskProfile[2]['point1'],
                                                provider.listOfOfficeRiskProfile[2]['point2'],
                                                provider.closedAssessmentList[index]['sitePoint1'],
                                                provider.closedAssessmentList[index]['sitePoint2'],
                                                provider.closedAssessmentList[index]['sitePoint3'],
                                                provider.closedAssessmentList[index]['sitePoint4'],
                                                provider.closedAssessmentList[index]['sitePoint5'],
                                                provider.closedAssessmentList[index]['wayForward1'],
                                                provider.closedAssessmentList[index]['wayForward2']);
                                            setState(() {
                                              loader[index] = false;
                                            });
                                          },
