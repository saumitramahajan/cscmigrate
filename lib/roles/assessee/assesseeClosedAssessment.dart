...
import 'package:mahindraCSC/roles/assessee/review/selfAssessment.dart';
...
class AssesseeClosedAssessment extends StatefulWidget {
  @override
  _AssesseeClosedAssessmentState createState() =>
      _AssesseeClosedAssessmentState();
}

class _AssesseeClosedAssessmentState extends State<AssesseeClosedAssessment> {
  String groupValue;
  String monthValue;
  String query;
                                      ...
                                      child: Row(children: [
                                        ...
                                        RaisedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            try {
                                              await provider.locations(
                                                  provider.closedAssessmentList[
                                                      index]['documentId']);
                                              // point1string = point1.text;
                                              // int n = point1string.length ~/ 85;
                                              // String point1new = '';

                                              // try {
                                              //   for (int i = 1; i <= n; i++) {
                                              //     point1string =
                                              //         point1string.replaceFirst(
                                              //             new RegExp(' '),
                                              //             '\n',
                                              //             (i * 85) - 5);
                                              //   }
                                              ...
                                              //   });
                                              // }
                                              // point2string = point2.text;
                                              // int o = point2string.length ~/ 85;
                                              // String point2new = '';

                                              // try {
                                              //   for (int i = 1; i <= o; i++) {
                                              //     point2string =
                                              //         point2string.replaceFirst(
                                              //             new RegExp(' '),
                                              //             '\n',
                                              //             (i * 85) - 5);
                                              //   }
                                              ...
                                              //   });
                                              // }
                                              // point3string = point3.text;
                                              // int p = point3string.length ~/ 85;
                                              // String point3new = '';

                                              // try {
                                              //   for (int i = 1; i <= p; i++) {
                                              //     point3string =
                                              //         point3string.replaceFirst(
                                              //             new RegExp(' '),
                                              //             '\n',
                                              //             (i * 85) - 5);
                                              //   }
                                              ...
                                              //   });
                                              // }
                                              // point4string = point4.text;
                                              // int q = point4string.length ~/ 85;
                                              // String point4new = '';

                                              // try {
                                              //   for (int i = 1; i <= q; i++) {
                                              //     point4string =
                                              //         point4string.replaceFirst(
                                              //             new RegExp(' '),
                                              //             '\n',
                                              //             (i * 85) - 5);
                                              //   }
                                              ...
                                              //   });
                                              // }
                                              // point5string = point5.text;
                                              // int r = point5string.length ~/ 85;
                                              // String point5new = '';

                                              // try {
                                              //   for (int i = 1; i <= r; i++) {
                                              //     point5string =
                                              //         point5string.replaceFirst(
                                              //             new RegExp(' '),
                                              //             '\n',
                                              //             (i * 85) - 5);
                                              //   }
